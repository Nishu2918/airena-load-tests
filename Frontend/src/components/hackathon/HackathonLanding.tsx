...
export function HackathonLanding({ onNavigate }: HackathonLandingProps) {
  ...
  const stats = [
    ...
    { label: 'AI Reviews', value: '0', icon: Brain },
  ];
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-white/70 -mt-1">The Global Arena for AI Builders</span>
                <span className="text-xs text-white/60 mt-0.5 font-medium">by 3AI and SashAI</span>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              >
                Organise Hackathon <ChevronRight className="w-5 h-5 ml-2" />
              </Button3D>
            </motion.div>
          </motion.div>
        </div>
